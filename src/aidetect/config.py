...
DEFAULT_FEATURE_CONTRIBUTIONS_PATH = PROCESSED_DIR / "feature_contributions.json"
DEFAULT_FEATURE_CONTRIBUTIONS_CSV_PATH = PROCESSED_DIR / "feature_contributions.csv"
DEFAULT_FEATURE_CONTRIBUTIONS_PLOT_PATH = PROCESSED_DIR / "feature_contributions.svg"
DEFAULT_OPTIMIZATION_PATH = PROCESSED_DIR / "optimization_summary.json"
DEFAULT_FINAL_REPORT_PATH = PROCESSED_DIR / "final_report.md"
